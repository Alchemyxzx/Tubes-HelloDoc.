...
$_SESSION['msg1']="Kata Sandi Berhasil Diubah !!";
}
else
{
$_SESSION['msg1']="Password Lama Tidak Cocok!!";
}
}
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Admin | Ganti Kata Sandi</title>
		<meta charset="utf-8" />
...
{
alert("Kata Sandi saat ini tidak boleh kosong!");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Ganti Kata Sandi</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
