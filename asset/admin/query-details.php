...
if($query){
echo "<script>alert('Pesan admin telah sukses di perbarui.');</script>";
...
<html lang="en">
	<head>
		<title>Admin | Detail Pesan</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Detail Pesan</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Kelola <span class="text-bold">Pesan Detail</span></h5>
...
<tr>
												<th>Terakhir update Pesan Admin</th>
