...
<textarea name="pataddress" class="form-control"  placeholder="Masukan alamat Pasien" required="true"></textarea>
</div>
<div class="form-group">
<label for="fess">
 umur
</label>
<input type="text" name="patage" class="form-control"  placeholder="Masukan Umur pasien " required="true">
</div>
<div class="form-group">
<label for="fess">
 Catatan Medis
</label>
<textarea type="text" name="medhis" class="form-control"  placeholder="Masukan Catatan Medis Pasien (jika punya)" required="true"></textarea>
</div>	
