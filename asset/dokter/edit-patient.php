...
if($sql)
{
echo "<script>alert('Info Pasien Telah Diperbarui');</script>";
...
<html lang="en">
	<head>
		<title>Dokter | Tambah Pasien</title>
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Masukan Catatan Medis (Jika ada)" required="true"><?php  echo $row['PatientMedhis'];?></textarea>
</div>	
<div class="form-group">
<label for="fess">
 Tanggal Dibuat
