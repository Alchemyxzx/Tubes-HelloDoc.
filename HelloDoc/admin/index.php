				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
								Silahkan Masukan Email dan Kata Sandi Anda.<br />
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									<input type="password" class="form-control password" name="password" placeholder="Kata Sandi"><i class="fa fa-lock"></i>
									 </span>
							</div>
