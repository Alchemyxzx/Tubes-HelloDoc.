							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Dokter </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="doctor-specilization.php">
											<span class="title"> Dokter Spesialis </span>
										</a>
									</li>
									<li>
									...
									<li>
										<a href="Manage-doctors.php">
											<span class="title"> Mengelola Dokter </span>
										</a>
									</li>
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="manage-users.php">
											<span class="title"> Mengelola Users </span>
										</a>
									</li>
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="manage-patient.php">
											<span class="title"> Mengelola Pasien </span>
										</a>
									</li>
...
<li>
								<a href="appointment-history.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Riwayat Janji </span>
										</div>
									</div>
								</a>
							</li>
	...
	<li>
								<a href="doctor-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Sesi Masuk Dokter </span>
										</div>
									</div>
								</a>
							</li>		
							...
							<li>
								<a href="user-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Sesi Masuk User </span>
										</div>
									</div>
								</a>
							</li>						
				<li>
								...
								<a href="patient-search.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Cari Pasien </span>
										</div>
									</div>
								</a>
							</li>
